...
sed -ie 's@foo@'"$accessToken"'@g' webexapp.service
sed -ie 's@bar@'"$person"'@g' webexapp.service
sed -ie 's@<user>@'"$USER"'@g' webexapp.service
sed -ie 's@<replace>@'"$PWD"'@g' webexapp.service
